...
saved_letter = check_input.letter(
    "Mit welcher Form arbeitest du?\nTrapez <T> | Parallelogramm <P> | Dreieck <D> | Rechteck <R>", "TPDR", True)

if saved_letter == "T":
    saved_letter = check_input.letter(
        "Was willst du vom Trapez berechenen??\nFlächeninhalt <F> | Länge der Mittellinie <M> | Höhe <H>", "FMH",
        True)
        ...
        print("Das Trapez hat eine Oberfläche von: " + str(
            JMath.trapeze.surface(check_input.number("Bitte die Höhe eingeben."),
                                  JMath.trapeze.middle_line(
                                      check_input.number("Bitte die Länge der oberen Linie eingeben."),
    ...
    saved_letter = check_input.letter(
        "Was willst du vom Parallelogramm berechnen?\nFlächeninhalt <F> | Höhe <H> | Länge der Grundlinie <G>", "FHG",
        True)
    ...
    if saved_letter == "H":
        print("Die Höhe ist: " + str(
            JMath.parallelogram.height_or_base_line(check_input.number("Bitte die Länge der Grundlinie eingeben."),
                                                    check_input.number("Bitte den Flächeninhalt eingeben."))))
